...
export declare class WebClient extends EventEmitter {
     ...
     */
    constructor(token?: string, { slackApiUrl, logger, logLevel, maxRequestConcurrency, retryConfig, agent, tls, pageSize, rejectRateLimitedCalls, clientId, clientSecret, refreshToken, }?: WebClientOptions);
    /**
